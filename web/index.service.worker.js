...
/** @type {string} */
const CACHE_VERSION = '1742601060|487119969';
/** @type {string} */
const CACHE_PREFIX = 'godot-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","dodge_the_creeps.wasm"];
